...
public class GroundTile : MonoBehaviour
{
    ...
    public GameObject forcefield_1,forcefield_duck,forcefield_jump,gateOrange_1,gateBlue_1,turretOrange,turretBlue;

    void SpawnObstacleGate()
    {
        int obstacleType = Random.Range(0,3); // obstacleType = 0(means different forcefields), = 1(means different gates), = 2(means turrets)
